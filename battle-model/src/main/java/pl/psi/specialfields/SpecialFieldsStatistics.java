...
public enum SpecialFieldsStatistics implements SpecialFieldIf {
    LAVA("Lava", true, false, true, false, 0, 10, 0),
    ROCK("Rock", false, false, false, false, 0, 0, 0),
    GUARD("Guard", true, true, false, false, 5, 10, 3),
    SWAMP("Swamp", false, false, true, true, 0, 0, 0);
    ...
    SpecialFieldsStatistics(String name, boolean isAttackPossible, boolean isAttackable, boolean isMovePossible, boolean isMoveRangeDebuffPossible, int hp, int damage, int amount) {
        this.name = name;
